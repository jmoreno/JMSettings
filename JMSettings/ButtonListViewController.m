...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [_arrayButtons objectAtIndex:indexPath.row];
...
- (void)settingsViewControllerDidFinishWithSelection:(NSString *)selection {
    [_arrayButtons replaceObjectAtIndex:[self.tableView.indexPathForSelectedRow row] withObject:selection];
    NSLog(@"%@", [_arrayButtons objectAtIndex:[self.tableView.indexPathForSelectedRow row]]);
